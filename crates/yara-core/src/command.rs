...
pub enum Command {
    ...
    SwapPanes,
    Close,
    // Workspaces: one agent in one worktree each, a tab apiece.
    NewTab,
    CloseTab,
    NextTab,
    PrevTab,
...
impl Command {
    ...
    pub fn label(&self) -> &'static str {
        match self {
            ...
            Self::Close => "Close",
            Self::NewTab => "New Workspace…",
            Self::CloseTab => "Close Workspace",
            Self::NextTab => "Next Workspace",
            Self::PrevTab => "Previous Workspace",
            Self::RenameTab => "Rename Workspace…",
            Self::Undo => "Undo",
            Self::Redo => "Redo",
            Self::Copy => "Copy",
            Self::Paste => "Paste",
