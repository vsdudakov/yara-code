...
between the panes: it lights up under the mouse, and dragging it up or down
shares the pane out between the agent and the shell, from a tenth to four
fifths, and keeps the share in the settings.
